                ...
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-right">
                            ...
                            <p><a class="btn btn-lg btn-primary" href="#" role="button">Registrarme ahora</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container marketing">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    ...
                    <p><a class="btn btn-secondary" href="contacto.html" role="button">Contactanos &raquo;</a></p>
                </div><!-- /.col-lg-4 -->
            ...
            <div class="row lista">
                <div class="card producto col-md-4">
                    <a href="producto.html" style="text-decoration: none; color: rgb(46, 46, 46);">
                        <img src="images/product-1.jpg" class="card-img-top" alt="Producto1">
                ...
                <div class="card producto col-md-4">
                    <a href="producto.html" style="text-decoration: none; color: rgb(46, 46, 46);">
                        <img src="images/product-2.jpg" class="card-img-top" alt="Producto2">
                        <div class="card-body">
                            <h3>$ 500</h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
                ...
                <div class="card producto col-md-4">
                    <a href="producto.html" style="text-decoration: none; color: rgb(46, 46, 46);">
                        <img src="images/product-3.jpg" class="card-img-top" alt="Producto3">
                        <div class="card-body">
                            <h3>$ 500</h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
                ...
                <div class="card producto col-md-4">
                    <a href="producto.html" style="text-decoration: none; color: rgb(46, 46, 46);">
                        <img src="images/product-2.jpg" class="card-img-top" alt="Producto1">
                        <div class="card-body">
                            <h3>$ 500</h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
                ...
                <div class="card producto col-md-4">
                    <a href="producto.html" style="text-decoration: none; color: rgb(46, 46, 46);">
                        <img src="images/product-3.jpg" class="card-img-top" alt="Producto1">
                        <div class="card-body">
                            <h3>$ 500</h3>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk
                                of
